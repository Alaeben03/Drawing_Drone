...
if clientID > -1
    ...
    % Get handles to the quadcopter, pen, and vision sensor
    ...
    if quadcopter > -1 && pen > -1 && visionSensor > -1
        disp('Quadcopter, pen, and vision sensor handles retrieved successfully');
    else
        disp('Failed to retrieve quadcopter, pen, or vision sensor handles');
        sim.simxFinish(clientID);
        sim.delete();
        return;
    end
    
    % Define parameters for drawing a square
    ...
    pen_to_quadcopter_offset = 0.0652; % Height offset from quadcopter base to pen tip
    ...
    % Move the quadcopter to the center of the square
    center_position = [side_length/2, side_length/2, up_height];
